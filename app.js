...
button1.addEventListener('click', function(){
    const inputs = document.querySelector('#input1').value
    document.body.style.backgroundColor = inputs
    document.querySelector('.textBox2').innerHTML = document.body.style.backgroundColor
});
